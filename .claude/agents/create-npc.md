...
Create a complete, usable NPC that fits the campaign context. For mechanical stat blocks (Health, Morale, abilities, Allegiances), read `resources/sots/INDEX.md` to find the relevant rulebook pages.
