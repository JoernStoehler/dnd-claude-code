...
Create a complete, usable NPC that fits the campaign context. Follow the process, output format, and design guidelines from the npc-design skill.

Write output to `campaigns/<campaign>/characters/npcs/<name-slug>.md`.
